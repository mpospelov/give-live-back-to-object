...
Gem::Specification.new do |s|
  ...
  s.files = [
    "lib/give-live-back-to-object.rb"
  ]
  s.homepage = "http://github.com/mixan946/give-live-back-to-object"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "2.0.14"
  s.summary = "This gem is provided for easy to use faye in Ruby!"
